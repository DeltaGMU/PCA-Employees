                    ...
                    <div>
                        ...
                        <div class="noSelect">
                            <div class="mb-1">
                                ...
                                <button type="button" class="mt-2 btn btn-danger" name="deleteEmployeeAccountBtn" :disabled="!canDelete" id="deleteEmployeeAccount" data-bs-toggle="modal" data-bs-target="#confirm-delete">
                                    Delete Account
                                </button>
                            </div>
                         </div>
